  ...
  return (
    <div className="portfolio">
      ...
      <img
        ...
        alt="A fantasy portrait of Jana in a whimsical purple forest"
      />
      <img
        src="/images/lavendar-dreams-2.jpg"
        alt="Jana sits against the dawn of the purple wood"
      />
      <img
        src="/images/lavendar-dreams-3.jpg"
        alt="A dream of Jana in lavender"
      />
      <img src="/images/paige-1.jpg" alt="Editorial portrait of Paige" />
      <img
      ...
      />
      <img src="/images/demons-2.jpg" alt="A demon against a red background" />
      <img src="/images/demons-3.jpg" alt="Manzin as a demon biting a chain" />
      <img
        src="/images/egan-2.jpg"
        alt="Egan is wearing ram horns and a white dress personifying Aries in this Gothesque editorial portrait"
      />
      <img
        src="/images/egan-1.jpg"
        alt="Egan wearing black horns, gloves, and corset for the Gothesque Magazine editorial"
      />
      <img
